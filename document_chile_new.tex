...
\cvname{Esteban M Díaz T} % Your name
\cvjobtitle{Computista} % Job title/career

\cvdate{23 de Octubre de 1992} % Date of birth
\cvaddress{United Kingdom} % Short address/location, use \newline if more than 1 line is required
\cvnumberphone{+39 9 9515 6801} % Phone number
\cvsite{https://linkedin.com/in/ediaz23} % Personal website
